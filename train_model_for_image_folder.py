...
def load_inception_resnet_v2(num_classes, finetune=True):
    ...
    pretrained_model_path = '~/.torch/models/inceptionresnetv2-d579a627.pth'
...
def main():
    ...
    if args.pretrained:
        ...
        #     original_model = models.__dict__[args.arch](pretrained=True, **{"transform_input": False})
    ...
    from data_balanced_image_folder import DataBalancedImageFolder as ImageFolder
    train_dataset = ImageFolder(
        traindir,
        transforms.Compose([
            transforms.Scale(args.image_size + 32),
    ...
    val_loader = torch.utils.data.DataLoader(
        ImageFolder(valdir, transforms.Compose([
            ...
            transforms.ToTensor(),
            normalize,
        ]), loader=my_pil_loader, balance_data=False),
